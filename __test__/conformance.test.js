...
// These tests are from the Flow and Babel repos, originally ported for my never-completed PR to add Flow to esbuild:
// https://github.com/evanw/esbuild/pull/384
...
test("Ported Flow parser tests", () => {
  ...
  expectPrintedFlow(
    t,
    "export type { PageLoadLatencyPluginType, PageLoadLatencyConfigType };\n",
    ""
  );
